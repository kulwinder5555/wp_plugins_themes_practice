...
class PublicScriptManager extends ScriptManager {
	...
	public function register() {
		 ...
		 * @since 4.11.1
		 */
		do_action( 'mphb_before_register_public_scripts' );
		...
		wp_register_script( 'mphb-jquery-serialize-json', $this->scriptUrl( 'vendors/jquery.serializeJSON/jquery.serializejson.min.js' ), array( 'jquery' ), MPHB()->getVersion(), true );
